...
<html lang="en">
            ...
            <nav>
               ...
               <div class="menu">
                  <ul>
                     ...
                     <li><a >You are logged in as ${admin.username}</a></li>
                  </ul>
               </div>
  ...
  <h2 align="center"  style="color:white">Welcome ${admin.username }</h2> <br>
  		
  		
  		<div class="container" align="center">
		
		<a href="${pageContext.request.contextPath}/AddAirport" ><button type="button" class="btnn warning btn-lg">Add New Airport</button></a>		
		<hr color=white >
		<hr color=white >
		<div class="row">
		<div class="col-md-6" >
		<div class="container" align="center">
		<a href="${pageContext.request.contextPath}/UpdateAirport"><button type="button" class="btnn info btn-lg">Update Airport</button></a>	 	
	 	<hr color=white>
	  	<a href="${pageContext.request.contextPath}/viewflight"><button type="button" class="btnn info btn-lg">View All Flights</button>	</a> 	
	 	...
	 	<div class="col-md-6" >
	 	<div class="container" align="center">
	 	<a href="${pageContext.request.contextPath}/RemoveAirport" ><button type="button" class="btnn danger btn-lg">Remove Airport</button></a> 
	 	<hr color=white>
	 	<a href="${pageContext.request.contextPath}/viewflight"><button type="button" class="btnn success btn-lg">Update Flights</button></a> 
	 	</div>
	 	</div>
	 	</div>
	 	<hr color=white><hr color=white >
	 	<div class="container" align="center">
	 	<a href="${pageContext.request.contextPath}/AdminLogout"><button type="button" class="btnn danger btn-lg">Log Out</button></a>
		</div>
	 	<div class="container" align="center">
	 		</div></div> 
