...
<html lang="en">
  ...
  <h2 align="center"  style="color:white">Airline Registration</h2> <hr>
  <h5 align="center" style="color:white">${message}</h5> <hr>
  
  <form action="${pageContext.request.contextPath}/registerAirline" method="post" style="color:white">
	 <div class="row">
		<div class="col-md-5">
	  <div class="form-group">
	    <label for="name">Airline Name</label>
	    <input type="text" class="form-control" name="name" required value="${airline.name}" placeholder="Enter Here">
	  </div>
	  </div>
	  <div class="col-md-7">
	  <div class="form-group">
	    <label for="email">Official Email address</label>
	    <input type="email" class="form-control" name="email" aria-describedby="emailHelp" value="${airline.email}" required placeholder="e.g. abcde@xyz.com">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" name="contact" maxlength="12" value="${airline.contact}" required placeholder="e.g. 9998887776">
	  </div>
	  
	   <div class="form-group">
	    <label for="manager">Manager's Name</label>
	    <input type="text" class="form-control" name="manager" value="${airline.manager}" required placeholder="Enter Here">
	  </div>
	  <div class="row">
	  <div class="col-md-6">
	   <div class="form-group">
	  ...
	  <input type="checkbox" class="form-check-input" id="acceptT&C" required>
	    <small>&ensp;&ensp;&ensp;I accept all <a href="${pageContext.request.contextPath}/airTnC" style="color:white"><i>T&Cs</i></a>.</small>
