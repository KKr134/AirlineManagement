...
<html lang="en">
  ...
  <h2 align="center"  style="color:white">UPDATE PLANE</h2> <hr>
  <h5 align="center" style="color:white">${message}</h5> <hr>
	 <form  action="${pageContext.request.contextPath}/Update/${plane.id}"  method="post" style="color:white">
	 
	   <div class="form-group">
	    <label for="name" style="color:white">New Plane Name</label>
	    <input type="text" class="form-control" name="name" required value="${plane.name}">
	  </div>
	  
	   <div class="form-group">
	    <label for="capacity">Capacity</label>
	    <input type="number" class="form-control" name="capacity" required value="${plane.capacity}">
	  </div>
	...
	<div class="form-group form-check">
	  ...
	  <button  type="submit" class="btnn info btn-lg">Submit</button></div><hr>
	</form>
	</div>
	</div> 
