  ...
  <body style="background-image: url('${pageContext.request.contextPath}/static/images/kk.jpg');">
      ...
      <div class="wrapper" >
			...
			<c:choose>
				  <c:when test="${ticket_count eq -1}">
				  	...
				  	<div class="jumbotron" align="center">
				  		<h1 align="center" >Cancelled Tickets</h1>
		...
		<section class="container">
			<h1 style="color:white">Cancelled Tickets</h1> 
			  ...
			  <c:forEach begin="0" end="${flight_count}" var="flight" items="${flights}">
			    ...
			    <article class="card fl-left" >
			      ...
			      <section class="card-cont">
			        ...
			        <a href="${pageContext.request.contextPath}/deleteTicket/${tickets[i].id}" >remove</a>
			      </section>
			    </article>
			    </c:if>
			    </c:forEach>
				...
				<c:if test="${flight.id eq tickets[i+1].fid}">
			     <article class="card fl-left" >
			      ...
			      <section class="card-cont">
			        ...
			        <div class="even-info">
			          <i class="fa fa-map-marker"></i>
			          <p style="font-size:1.5em  ;color:#9307FF"> ${flight.from_} ${flight.dtime}</p> <p style="font-size:1.5em ;color:#00DFBC">>>></p>
			            <p style="font-size:1.5em ; color:#074BAF"> ${flight.to_}  ${flight.atime}</p>
