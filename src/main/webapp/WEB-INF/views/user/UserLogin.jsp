...
<html lang="en">
            ...
            <nav>
               ...
               <div class="menu">
                  <ul>
                     ...
                     <li><a href="${pageContext.request.contextPath}/UserRegistration">New user Sign up</a></li>
  ...
  <h2 align="center"  style="color:white">User Login</h2> <hr>
  <h5 align="center" style="color:white">${message}</h5> <hr>
	 <form  action="${pageContext.request.contextPath}/UserDashboard"  method="post" style="color:white">
	  ...
	  <div class="form-group form-check" >
	    ...
	    <small>New user? <a href="${pageContext.request.contextPath}/UserRegistration" style="color:white"> Sign up here</a></small>
	  </div>
